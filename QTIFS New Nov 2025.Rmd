...
library(readxl)      # reading Excel files if used elsewhere
library(janitor)     # data cleaning and column name formatting
library(ggpubr)      # ggplot helpers and statistical annotations
library(patchwork)   # combining multiple ggplots
library(viridis)     # color palettes
library(ggalluvial)  # alluvial/flow diagrams
library(scales)      # axis scaling and labels
...
# heatmap
# ggsave("Heatmap.pdf", width = 7, height = 5)
...
# themes
# ggsave("Recommendation Categories Bar Chart.pdf", width = 6, height = 4)
...
# plan
# ggsave("Plan Inclusion Bar Chart.pdf", width = 5, height = 5)
...
# testing
# ggsave("Real World Testing Bar Chart.pdf", width = 5, height = 5)
...
# responsibility
# ggsave("Implementation Level.pdf", width = 6, height = 4)
...
# ggsave("combined_plots.pdf", height = 10, width = 12)
...
# ggsave("flow_of_recs.pdf", width = 8, height = 6)
